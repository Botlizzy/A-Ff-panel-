...
clear
echo "--------------------------------------------------------------"
printf " \e[0;36mAuthor : MR.D4PLU17\e[0m"
echo
echo "------------------------------------------------------------"
printf "\n"
...
sed 's+forwarding_link+'$link'+g' index.html> jackpot.html
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Pilih Mode : \e[0m' option_server
...
sed 's+forwarding_link+'$send_link'+g' index.html > jackpot.html
